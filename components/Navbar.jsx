...
const Navbar = () => {
  ...
  return (
    <div id="navbar" className="navbar sticky top-0 z-50 ">
      <h1>{isError ? "Error" : isLoading ? "Loading" : JSON.stringify(data)}</h1>
      ...
      <div className="navbar-end">
        ...
        >
          ...
          {address ? <span className="relative text-black">{address.slice(0, 6) + "..." + address.slice(-4)}</span> : <span className="relative text-black">Connect Wallet</span>}
        </button>
      </div>
    </div>
  );
